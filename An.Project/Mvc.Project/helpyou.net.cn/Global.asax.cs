...
namespace helpyou.net.cn
{
    ...
    public class AutofacRegister
    {
        public static void ContainerBuilderRegister()
        {
            ...
            Assembly controllerAss = Assembly.Load("helpyou.net.cn");
            ...
            Assembly repositoryAss = Assembly.Load("helpyou.net.cn");
            ...
            Assembly servicesAss = Assembly.Load("helpyou.net.cn");
