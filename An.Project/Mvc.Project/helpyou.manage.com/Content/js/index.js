...
layui.define(['element', 'layer', 'form'], function (exports) {
    ...
    function login() {
        ...
        loginHtml += '<img id="valiCode" style="cursor: pointer;width:100px;" src="PartView/GetValidateCode"   alt="验证码" /><input type="text" name="yzm" class="layui-input" style="width:150px; float: left; margin-right:30px"/>';
        loginHtml += '</div>';
        loginHtml += '</div>';
