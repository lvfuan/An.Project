...
namespace Helper.Common
{
    public class ImageHelper
    {
        ...
        public static void MakeThumbnail(string originalImagePath, string thumbnailPath, int width, int height, AbbreviationsType type)
        {
            ...
            switch (type)
            {
                case AbbreviationsType.HW:  //指定高宽缩放（可能变形）  
                    break;
                case AbbreviationsType.W:   //指定宽，高按比例                      
                    toheight = originalImage.Height * width / originalImage.Width;
                    break;
                case AbbreviationsType.H:   //指定高，宽按比例  
                    towidth = originalImage.Width * height / originalImage.Height;
                    break;
                case AbbreviationsType.Cut: //指定高宽裁减（不变形）                  
            ...
            try
            {
                ...
                var newpath = Path.GetDirectoryName(originalImagePath) + filename + Path.GetExtension(originalImagePath);
                bitmap.Save(newpath);
            }
            catch (Exception e)
            {
